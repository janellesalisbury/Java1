...
public class CensusRecords {
	...
	CensusRecords(int myTotalPopulation, int myTotalMen, int myTotalWomen, String myLocation){
	...
	CensusRecords(String myLocation, String APIDeveloperKey){
		//turn zip into state
